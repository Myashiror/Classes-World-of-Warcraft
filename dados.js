let dados = [
        {
            ...
            tags:["monk", "classes", "classe", "class", "versátil", "artes marciais", "tanque", "heal", "curador", "tank", "DPS", "heal", "corpo a corpo", "chi", "curador", "healer", "energia"]
        },
        {
            titulo: "Caçador",
            ...
            tags:["Hunter", "classes", "classe", "class", "distância", "dps", "arco", "besta", "armas de fogo", "marca de caça", "sobrevivência", "bestas"]
        },
        {
            titulo: "Paladino",
            ...
            tags:["sagrado", "luz", "classes", "classe", "class", "tank", "dps", "justiça", "curador", "healer", "cruzado", "aura", "proteção", "heal", "retalho"]
        },
        {
            titulo: "Mago",
            ...
            tags:["Mage", "arcano", "dps", "classes", "classe", "class", "fogo", "gelo", "feitiço", "conjuração", "elemental"]
        },
        {
            titulo: "Sacerdote",
            ...
            tags:["Priest", "cura", "sombra", "classes", "classe", "class", "dps", "curador", "healer", "dispelação", "ressurreição", "heal", "sagrado",]
        },
        {
            titulo: "Ladino",
            ...
            tags:["Rogue", "stealth", "dps", "classes", "classe", "class", "energia", "combate corpo a corpo", "combate", "rog",]
        },
        {
            titulo: "Bruxo",
            ...
            tags:["Lock", "demônio", "invocação", "classes", "classe", "class", "dps", "maldição", "feitiço", "corrupção", "sombras",]
        },
        {
            titulo: "Guerreiro",
            ...
            tags:["War", "arms", "tank", "armadura", "classes", "classe", "class", "dps", "fury", "tanque", "DPS", "corpo a corpo",]
        },
        {
            ...
            tags:["DK", "morte", "runas", "dps", "classes", "classe", "class", "pragas", "sangue", "Death Knight", "tanque", "DPS",]
        },
        {
            ...
            tags:["Dh", "demônio", "caos", "tank", "classes", "classe", "class", "tanque", "dps", "energia vil", "metamorfose", "corpo a corpo", "mobilidade",]
        },
        {
            titulo: "Xamã",
            ...
            tags:["Shamy", "elemental", "totem", "classes", "classe", "class", "espírito", "natureza", "cura", "curador", "healer", "heal", "DPS",]
        },
        {
            titulo: "Druida",
            ...
            tags:["Druid", "natureza", "classes", "classe", "class", "transformação", "tank", "tanque", "cura", "tanque", "DPS", "equilíbrio", "stealth", "heal", "curador", "healer", "Feral",]
        },
        {
            titulo: "Conjurante",
            ...
            tags:["Evoker", "curador", "classes", "classe", "class", "healer", "dragão", "magia", "malha", "cura", "DPS", "heal", "convoker", "conjurante", "elemental",]
        }
];
